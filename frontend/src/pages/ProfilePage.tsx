  ...
  const [formData, setFormData] = useState({
    ...
    preferences: {
      ...
      privacy: {
        ...
        allowDataSharing: user?.preferences?.privacy?.allowDataSharing ?? false
      }
    }
  });
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        console.log('File read successfully, setting avatar');
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-2 sm:px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:border-purple-500 focus:outline-none text-sm sm:text-base"
                        >
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className={`w-12 h-6 rounded-full ${formData.preferences.notifications.email ? 'bg-green-500' : 'bg-gray-500'} relative transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500`}
                          >
                            <div className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-transform ${formData.preferences.notifications.email ? 'translate-x-6' : 'translate-x-0.5'}`}></div>
                          </button>
                        </div>
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            onClick={() => setFormData({
                              ...
                              preferences: {
                                ...
                                notifications: {
                                  ...formData.preferences.notifications,
                                  browser: !formData.preferences.notifications.browser
                                }
                              }
                            })}
                            className={`w-12 h-6 rounded-full ${formData.preferences.notifications.browser ? 'bg-green-500' : 'bg-gray-500'} relative transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500`}
                          >
                            <div className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-transform ${formData.preferences.notifications.browser ? 'translate-x-6' : 'translate-x-0.5'}`}></div>
                          </button>
                        </div>
                      </div>
                    </div>
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-4 sm:p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {!user.isVerified && (
                      <button className="px-2 py-1 bg-blue-500/20 text-blue-400 rounded-full text-xs hover:bg-blue-500/30 transition-colors">
                        Verify Email
                      </button>
                    )}
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2 py-1 rounded-full text-xs bg-gray-500/20 text-gray-400 capitalize">
              ...
              <div className="mt-4 pt-4 border-t border-white/10">
                <h4 className="text-white font-medium text-sm mb-3">Notifications</h4>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-white/70 text-xs">Email Notifications</span>
                    <div className={`w-8 h-4 rounded-full ${user.preferences?.notifications?.email ? 'bg-green-500' : 'bg-gray-500'} relative cursor-pointer transition-colors`}>
                      <div className={`w-3 h-3 bg-white rounded-full absolute top-0.5 transition-transform ${user.preferences?.notifications?.email ? 'translate-x-4' : 'translate-x-0.5'}`}></div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-white/70 text-xs">Browser Notifications</span>
                    <div className={`w-8 h-4 rounded-full ${user.preferences?.notifications?.browser ? 'bg-green-500' : 'bg-gray-500'} relative cursor-pointer transition-colors`}>
                      <div className={`w-3 h-3 bg-white rounded-full absolute top-0.5 transition-transform ${user.preferences?.notifications?.browser ? 'translate-x-4' : 'translate-x-0.5'}`}></div>
                    </div>
                  </div>
                </div>
              </div>
